        ...
        <div class="queryResults">
            <?php
                ...
                if(isset($_GET['id'])) {
                    ...
                    // Fetch event record from the database
                    ...
                    if ($result->num_rows == 1) {
                        ...
                        // Fetch pictures associated with the event from the database
                        $sql_pictures = "SELECT * FROM pictures WHERE id = $id";
                        ...
                        <div class="container">
                            ...
                            <form action="update.php" method="post"  enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" placeholder="Activity Name" name="name" value="<?php echo $row['name'];?>">
                                </div>
                                
                                <div class="mb-3">
                                    <label for="edition" class="form-label">Edition:</label>
                                    <input type="text" class="form-control" id="edition" placeholder="Edition:" name="edition" value="<?php echo $row['edition']; ?>">
                                </div>

                                <div class="mb-3">
                                    <label for="location" class="form-label">Location:</label>
                                    <input type="text" class="form-control" id="location" placeholder="Location:" name="location" value="<?php echo $row['location']; ?>">
                                </div>

                                <div class="row">
                                    <div class="mb-3 col-md-6">
                                        <label for="dateStart" class="form-label label1">Start Date:</label>
                                        <input type="date" class="form-control" id="dateStart" placeholder="Start date:" name="dateStart" value="<?php echo $row['dateStart']; ?>">
                                    </div>

                                    <div class="mb-3 col-md-6">
                                        <label for="dateEnd" class="form-label label1">End Date:</label>
                                        <input type="date" class="form-control" id="dateEnd" placeholder="End Date:" name="dateEnd" value="<?php echo $row['dateEnd']; ?>">
                                    </div>
                                </div>

                                <div class="mb-3">
                                    <label for="description">Description:</label>
                                    <textarea class="form-control" rows="5" id="description" name="description"><?php echo $row['description']; ?></textarea>
                                </div>
                ...
                ?>
                                        <tr>
                                            <td><img src="./../img/<?php echo $row_picture['url']; ?>" class="img-thumbnail" style="max-width: 100px;"></td>
                                            <td><input type="checkbox" name="remove_picture[]" value="<?php echo $row_picture['id'] . '|' . $row_picture['url']; ?>"></td>
                                        </tr>
                <?php
                        }
                ?>
